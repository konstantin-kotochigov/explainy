...
4. Сохраняет каждое объяснение в отдельный файл в директории `outputs/`
...
4. Результаты будут сохранены в директории `outputs/` в виде отдельных текстовых файлов для каждой темы
